...
function navbar()
  ...
  useEffect(()=>{
    ...
    return()=>{
      ...
      const navItems=(<>   
     <li><a href="/">Home</a></li>
      <li> <a href="/Exams">Library</a> </li>
      <li><a>Quiz</a></li>
      <li><a>Blog</a></li>
      <li><a>Ecampus Tour</a></li>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-1000 rounded-box w-52">
      {navItems}
      </ul>
    </div>
    <a className="btn btn-ghost text-2xl font-bold cursor-pointer" href='/'>Elearning</a>
  </div>
